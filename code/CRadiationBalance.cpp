...
CRadiationBalance::CRadiationBalance()
{
	;
}

void CRadiationBalance::execute()
{


}

void CRadiationBalance::init(OPTIONSTRUCT *Options, int HeatFluxOption, int CanopyRadAttOption,
		      ...
		      VEGTABLE *VType, SNOWPIX *LocalSnow, PIXRAD *LocalRad)
{
    ...
    m_Options = Options;
    m_HeatFluxOption = HeatFluxOption;
    m_CanopyRadAttOption = CanopyRadAttOption;
    m_SineSolarAltitude = SineSolarAltitude;
    m_VIC_Rs = VIC_Rs;
    m_Rs = Rs;
    m_Rsb = Rsb;
    m_Rsd = Rsd;
    ...
    m_Tcanopy = Tcanopy;
    m_Tsoil = Tsoil;
    m_SoilAlbedo = SoilAlbedo;
    m_VType = VType;
    m_LocalSnow = LocalSnow;
    m_LocalRad = LocalRad;


    execute(m_Options, m_HeatFluxOption, m_CanopyRadAttOption, m_SineSolarAltitude, m_VIC_Rs,
            m_Rs, m_Rsb, m_Rsd, m_Ld, m_Tair, m_Tcanopy, m_Tsoil, m_SoilAlbedo, m_VType, m_LocalSnow, m_LocalRad);
}

void CRadiationBalance::execute(OPTIONSTRUCT *Options, int HeatFluxOption, int CanopyRadAttOption,
		      float SineSolarAltitude, float VIC_Rs, float Rs,
		      float Rsb, float Rsd, float Ld, float Tair,
		      float Tcanopy, float Tsoil, float SoilAlbedo,
		      VEGTABLE *VType, SNOWPIX *LocalSnow, PIXRAD *LocalRad)
...
void CRadiationBalance::ShortwaveBalance(OPTIONSTRUCT *Options, unsigned char OverStory, float F, float Rs,
...
void CRadiationBalance::LongwaveBalance(OPTIONSTRUCT *Options, unsigned char OverStory, float F,
